#!/bin/bash
#SBATCH --job-name=bzc_blink
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_blink_%j.out
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_blink_%j.err
#SBATCH --ntasks=1
...
# Bagel-Zebra-CoT zero-shot on BLINK Multi-view_Reasoning
set -euo pipefail
