#!/bin/bash
#SBATCH --job-name=rethink_und_mmsi
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/rethink_und_mmsi_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/rethink_und_mmsi_error.txt
#SBATCH --ntasks=1
...
#
# MMSI-Bench Understanding Rethink Inference — 1 GPU
#
# Feeds pre-generated thinking images back as additional input (no new generation).
#
# Usage:
#   sbatch eval_mmsi_bench_rethink_understanding.sh
#
set -euo pipefail
...
RESULTS_DIR="${RESULTS_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_rotation_balance_visual_only_mmsi_eval}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_understanding_mmsi}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "MMSI-Bench Understanding Rethink Inference (1-GPU)"
echo "=============================================="
echo "Configuration:"
