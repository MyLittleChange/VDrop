#!/bin/bash
#SBATCH --job-name=bagel_mc_all_bm_lora_6k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL MindCube Inference — 2 GPUs on main
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k}"
...
echo "BAGEL MindCube (visual_only_thinking) — Model: $MODEL_PATH | Shards: $NUM_SHARDS | Batch: $SHARD_BATCH"
