#!/bin/bash
#SBATCH --job-name=DatagenArchivePreGPU
#SBATCH --partition=main
#SBATCH -c 4
#SBATCH --mem=32Gb
#SBATCH --time=24:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/archive_pregpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/archive_pregpu_error-%j.txt
...
# Run BEFORE run_datagen_archive_gpu.sh.
# Usage: sbatch run_datagen_archive_pregpu.sh
# ==============================================================================
...
log "Next step: sbatch run_datagen_archive_gpu.sh"
