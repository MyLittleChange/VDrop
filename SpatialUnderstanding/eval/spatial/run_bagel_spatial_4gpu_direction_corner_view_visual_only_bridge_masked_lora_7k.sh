#!/bin/bash
#SBATCH --job-name=bagel_spat_dir_all_cv_bm_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_corner_view_visual_only_bridge_masked_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_corner_view_visual_only_bridge_masked_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_corner_view_visual_only_bridge_masked_lora_7k_mcqs_relative_direction_normalized}"
