#!/bin/bash
#SBATCH --job-name=bzc_spat_dir
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_spat_dir_%j.out
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_spat_dir_%j.err
#SBATCH --ntasks=1
...
# Bagel-Zebra-CoT on COSMIC spatial: direction only (2 GPUs / NUM_SHARDS=2 to fit main)
set -euo pipefail
