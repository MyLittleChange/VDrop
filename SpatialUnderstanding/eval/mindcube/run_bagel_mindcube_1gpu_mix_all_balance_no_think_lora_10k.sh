#!/bin/bash
#SBATCH --job-name=bagel_mindcube_1gpu_balance_nt_lora10k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_all_balance_no_think_lora_10k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_all_balance_no_think_lora_10k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_mix_all_balance_no_think_lora_10k}"
