#!/bin/bash
#SBATCH --job-name=bagel_stare_vanilla
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_vanilla_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_vanilla_error.txt
#SBATCH --ntasks=1
...
# Usage:
#   sbatch run_bagel_stare_perspective_1gpu_vanilla.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_vanilla}"
