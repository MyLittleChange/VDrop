#!/bin/bash
#SBATCH --job-name=bagel_spat_anc_all_pm_no_rot_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_training_data_pm_no_rotation_visual_only_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_training_data_pm_no_rotation_visual_only_lora_7k_error.txt
#SBATCH --ntasks=1
...
# Model: BAGEL_format_training_data_pm_no_rotation_visual_only_lora_7k
...
# ==================== Configuration ====================
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_training_data_pm_no_rotation_visual_only_lora_7k}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_pm_no_rotation_visual_only_lora_7k_mcqs_anchor_normalized}"
...
echo "Model: BAGEL_format_training_data_pm_no_rotation_visual_only_lora_7k"
echo "=============================================="
echo "Configuration:"
