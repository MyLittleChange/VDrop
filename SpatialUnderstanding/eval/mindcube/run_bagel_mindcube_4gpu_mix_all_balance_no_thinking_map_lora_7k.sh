#!/bin/bash
#SBATCH --job-name=bagel_mc_all_nt_map_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_all_balance_no_thinking_map_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_all_balance_no_thinking_map_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_training_data_mix_all_balance_no_thinking_map_lora_7k}"
...
echo "BAGEL MindCube (no_thinking) — Model: $MODEL_PATH | Shards: $NUM_SHARDS | Batch: $SHARD_BATCH"
