#!/bin/bash
# Submit benchmark eval jobs for the pm_no_rotation bridge-masked LoRA 7k checkpoint:
#   BAGEL_format_pm_no_rotation_visual_only_bridge_masked_lora_7k
#
...
CKPT=pm_no_rotation_visual_only_bridge_masked_lora_7k
