#!/bin/bash
#SBATCH --job-name=bagel_stare_mat_pm_vo_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_balance_matterport_point_matching_visual_only_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_balance_matterport_point_matching_visual_only_lora_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_format_training_data_mix_balance_matterport_point_matching_visual_only_lora}"
