#!/bin/bash
#SBATCH --job-name=bagel_spat_dst_all_bm_nw03_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_distance_mix_all_balance_visual_only_bridge_masked_no_warmup_0.3_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_distance_mix_all_balance_visual_only_bridge_masked_no_warmup_0.3_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_all_balance_visual_only_bridge_masked_no_warmup_0.3_lora_7k_mcqs_relative_distance_normalized}"
