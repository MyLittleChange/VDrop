#!/bin/bash
#SBATCH --job-name=bagel_mindcube_mat_pm_vo_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_balance_matterport_point_matching_visual_only_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_balance_matterport_point_matching_visual_only_lora_error.txt
#SBATCH --ntasks=1
