#!/bin/bash
#SBATCH --job-name=gemini_topdown
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/run_inference_gemini_topdown_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/run_inference_gemini_topdown_error.txt
#SBATCH --ntasks=1
...
# Output directory
OUTPUT_DIR="/path/to/scratch/VisualCoT/Gemini_topdown"
...
log "=============================================="
log "Gemini Topdown Map Spatial Collab Inference Script"
log "=============================================="
...
for DATASET_FILE in "${DATASET_FILES[@]}"; do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/${MODEL_SHORT_NAME}_topdown_${DATASET_BASENAME}.json"
    ...
    python /path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/spatial/run_inference_gemini_topdown.py \
