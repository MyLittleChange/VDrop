#!/bin/bash
#SBATCH --job-name=mmsi_acd_nt_lora10k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_anchor_counting_distance_balance_no_think_lora_lora_10k_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_anchor_counting_distance_balance_no_think_lora_lora_10k_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_anchor_counting_distance_balance_no_think_lora_lora_10k_mmsi_eval}"
