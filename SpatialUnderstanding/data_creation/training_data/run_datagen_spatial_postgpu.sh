#!/bin/bash
#SBATCH --job-name=SpatialPostGPU
#SBATCH -c 4
#SBATCH --mem=32Gb
#SBATCH --time=12:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_postgpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_postgpu_error-%j.txt

# ==============================================================================
# Post-GPU stages for NEW SPATIAL scenes:
#   scene_bound_objects, scene_obj_color_info, scene_generate_descriptions,
#   scene_solve_perception, scene_generate_questions, scene_generate_maps,
#   scene_generate_paraphrase, aggregate_data, filter_questions
# Requires: VisualCoT_GEMINI env var set before submitting.
# Run AFTER run_datagen_spatial_gpu.sh.
# Usage: sbatch run_datagen_spatial_postgpu.sh
# ==============================================================================
...
log "Starting post-GPU datagen stages (spatial scenes)..."
