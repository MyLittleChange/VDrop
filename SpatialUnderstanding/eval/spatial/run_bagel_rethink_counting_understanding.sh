#!/bin/bash
#SBATCH --job-name=rethink_und_counting
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/rethink_und_counting_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/rethink_und_counting_error.txt
#SBATCH --ntasks=1
...
#
# Usage:
#   sbatch run_bagel_rethink_counting_understanding.sh
#
set -euo pipefail
...
RESULTS_FILE="${RESULTS_FILE:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_rotation_balance_visual_only_mcqs_counting_normalized/inference_results_bagel_merged.json}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_understanding_mcqs_counting_normalized}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "Understanding Rethink Eval (1-GPU) — Counting"
echo "=============================================="
echo "Configuration:"
