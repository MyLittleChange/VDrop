#!/bin/bash
#SBATCH --job-name=fnvt_counting_visual_only_b
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_visual_only_bridge_masked_lora_7k_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_visual_only_bridge_masked_lora_7k_force_no_vt_error.txt
#SBATCH --ntasks=1
...
# Task: counting | Model: visual_only_bridge_masked_lora_7k
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_all_balance_visual_only_bridge_masked_lora_7k_mcqs_counting_normalized_force_no_vt}"
...
echo "=============================================="
echo "BAGEL Spatial - force_no_visual_thinking (counting)"
