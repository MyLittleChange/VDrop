#!/bin/bash
#SBATCH --job-name=fnvt_blink_visual_only_brid
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_visual_only_bridge_masked_lora_7k_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_visual_only_bridge_masked_lora_7k_force_no_vt_error.txt
#SBATCH --ntasks=1
...
SPLIT="${SPLIT:-val}"
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/blink/BAGEL_format_mix_all_balance_visual_only_bridge_masked_lora_7k_force_no_vt}"
