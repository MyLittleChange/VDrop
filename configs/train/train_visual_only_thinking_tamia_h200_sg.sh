#!/bin/bash
#SBATCH --job-name=train_visual_only_rotation_balance
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/scripts/train_visual_only_rotation_balance_h200_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/scripts/train_visual_only_rotation_balance_h200_error.txt
#SBATCH --ntasks=1
#SBATCH --nodes=1
...
OUTPUT_PATH="/path/to/scratch/VisualCoT/training_outputs/training_data_mix_all_rotation_balance_visual_only_matterport_rotation"
CKPT_PATH="/path/to/scratch/VisualCoT/BAGEL_checkpoints/training_data_mix_all_rotation_balance_visual_only_matterport_rotation"
...
log "=============================================="
log "Starting ThinkMorph Visual-Only rotation_balance Training"
log "=============================================="
...
torchrun \
  ...
  --ce_weight 1 \
  --wandb_offline True \
  --wandb_name training_data_mix_all_rotation_balance_visual_only_matterport_rotation \
  --total_steps 4000 \
  --save_every 2000 \
  --num_shard 8
