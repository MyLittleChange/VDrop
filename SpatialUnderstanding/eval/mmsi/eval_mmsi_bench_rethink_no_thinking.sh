#!/bin/bash
#SBATCH --job-name=mmsi_rethink_no_thinking
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_rethink_no_thinking_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_rethink_no_thinking_error.txt
#SBATCH --ntasks=1
...
#
# Usage:
#   sbatch eval_mmsi_bench_rethink_no_thinking.sh
#
set -euo pipefail
...
# ==================== Configuration ====================
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_panorama_qa_no_thinking}"  # no_thinking finetuned model
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_panorama_qa_no_thinking_mmsi}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "MMSI-Bench Rethink Inference (1-GPU) — no_thinking finetuned"
echo "=============================================="
echo "Configuration:"
