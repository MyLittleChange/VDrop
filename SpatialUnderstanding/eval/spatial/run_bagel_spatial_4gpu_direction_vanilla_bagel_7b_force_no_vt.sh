#!/bin/bash
#SBATCH --job-name=fnvt_direction_vanilla_bage
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_force_no_vt_error.txt
#SBATCH --ntasks=1
...
# Task: direction | Model: vanilla_bagel_7b
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_7B_MoT_pretrained_mcqs_relative_direction_normalized_force_no_vt}"
