...
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_1gpu_mix_balance_matterport_point_matching_visual_only_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_1gpu_mix_balance_matterport_point_matching_visual_only_lora_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL OmniSpatial Benchmark Inference — 1 GPU on unkillable (finishes shard 3 of existing 4-shard split)
...
echo "=============================================="
echo "BAGEL OmniSpatial Benchmark Inference (1-GPU unkillable, visual_only_thinking, shard 3 cleanup)"
