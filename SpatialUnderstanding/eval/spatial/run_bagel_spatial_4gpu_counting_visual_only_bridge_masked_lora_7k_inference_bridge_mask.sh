#!/bin/bash
#SBATCH --job-name=ibm_counting_visual_only_b
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_visual_only_bridge_masked_lora_7k_inference_bridge_mask_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_visual_only_bridge_masked_lora_7k_inference_bridge_mask_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_all_balance_visual_only_bridge_masked_lora_7k_mcqs_counting_normalized_inference_bridge_mask}"
...
echo "=============================================="
echo "BAGEL Spatial — inference_bridge_mask probe (counting)"
