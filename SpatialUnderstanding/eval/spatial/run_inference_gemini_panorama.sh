#!/bin/bash
#SBATCH --job-name=gemini_panorama
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/run_inference_gemini_panorama_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/run_inference_gemini_panorama_error.txt
#SBATCH --ntasks=1
...
# Output directory
OUTPUT_DIR="/path/to/scratch/VisualCoT/Gemini_panorama"
...
log "=============================================="
log "Gemini Panorama View Spatial Collab Inference Script"
log "=============================================="
log "Model: $MODEL_NAME"
log "Thinking Level: $THINKING_LEVEL"
log "Data Dir: $DATA_DIR"
log "Datasets: ${DATASET_FILES[*]}"
...
for DATASET_FILE in "${DATASET_FILES[@]}"; do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/${MODEL_SHORT_NAME}_panorama_${DATASET_BASENAME}.json"
    ...
    python /path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/spatial/run_inference_gemini_panorama.py \
