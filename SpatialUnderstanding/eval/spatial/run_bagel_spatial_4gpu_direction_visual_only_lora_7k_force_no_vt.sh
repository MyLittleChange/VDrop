...
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_visual_only_lora_7k_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_visual_only_lora_7k_force_no_vt_error.txt
#SBATCH --ntasks=1
...
# Task: direction | Model: visual_only_lora_7k
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_balance_visual_only_lora_7k_mcqs_relative_direction_normalized_force_no_vt}"
...
echo "Model: visual_only_lora_7k"
echo "=============================================="
