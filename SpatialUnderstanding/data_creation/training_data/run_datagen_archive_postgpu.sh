#!/bin/bash
#SBATCH --job-name=DatagenArchivePostGPU
#SBATCH --partition=long
#SBATCH -c 4
#SBATCH --mem=32Gb
#SBATCH --time=12:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/archive_postgpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/archive_postgpu_error-%j.txt
...
# Run AFTER run_datagen_archive_gpu.sh.
# Usage: sbatch run_datagen_archive_postgpu.sh
# ==============================================================================
