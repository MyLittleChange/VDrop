#!/bin/bash
#SBATCH --job-name=bagel_map_all_bm_nw_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_4gpu_mix_all_balance_visual_only_bridge_masked_no_warmup_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_4gpu_mix_all_balance_visual_only_bridge_masked_no_warmup_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_all_balance_visual_only_bridge_masked_no_warmup_lora_7k_map}"
