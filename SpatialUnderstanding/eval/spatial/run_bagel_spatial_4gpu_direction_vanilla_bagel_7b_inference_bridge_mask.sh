#!/bin/bash
#SBATCH --job-name=ibm_direction_vanilla_bage
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_inference_bridge_mask_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_inference_bridge_mask_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_7B_MoT_pretrained_mcqs_relative_direction_normalized_inference_bridge_mask}"
