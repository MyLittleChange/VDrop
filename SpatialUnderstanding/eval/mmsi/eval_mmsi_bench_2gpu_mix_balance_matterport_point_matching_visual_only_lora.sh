#!/bin/bash
#SBATCH --job-name=mmsi_mat_pm_vo_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_balance_matterport_point_matching_visual_only_lora_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_balance_matterport_point_matching_visual_only_lora_error_%a.txt
#SBATCH --ntasks=1
...
#
# MMSI-Bench Inference Script — 2 GPUs per job (SLURM array)
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_balance_matterport_point_matching_visual_only_lora_mmsi_eval}"
