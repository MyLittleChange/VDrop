#!/bin/bash
#SBATCH --job-name=SpatialGPU
#SBATCH --partition=short-unkillable
#SBATCH --gres=gpu:a100l:4
#SBATCH -c 24
#SBATCH --mem=200Gb
#SBATCH --time=2:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_gpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_gpu_error-%j.txt

# ==============================================================================
# GPU stage for NEW SPATIAL scenes: scene_llm_visible_objects (Qwen3-VL-235B via vLLM)
# Run AFTER run_datagen_spatial_pregpu.sh and BEFORE run_datagen_spatial_postgpu.sh.
# Usage: sbatch run_datagen_spatial_gpu.sh
# ==============================================================================
...
SCENE_DATAFILE="/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/dataset_new_scenes_v5.json"
QUESTION_VERSION="V5"
...
VLLM_LOG="${LOG_DIR}/spatial_vllm_server-${SLURM_JOB_ID}.log"
...
# Wait for server to be ready (up to 20 minutes)
...
log "Next step: sbatch run_datagen_spatial_postgpu.sh"
