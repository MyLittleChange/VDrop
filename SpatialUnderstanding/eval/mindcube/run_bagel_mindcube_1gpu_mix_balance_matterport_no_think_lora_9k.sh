#!/bin/bash
#SBATCH --job-name=bagel_mc_mat_nt_lora9k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_balance_matterport_no_think_lora_9k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_balance_matterport_no_think_lora_9k_error.txt
#SBATCH --ntasks=1
...
# Usage:
#   sbatch run_bagel_mindcube_1gpu_mix_balance_matterport_no_think_lora_9k.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_training_data_mix_balance_matterport_no_think_lora_9k}"
