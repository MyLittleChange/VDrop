#!/bin/bash
#SBATCH --job-name=blink_mv_mat_pm_nt_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_mix_balance_matterport_point_matching_no_think_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_mix_balance_matterport_point_matching_no_think_lora_error.txt
#SBATCH --ntasks=1
...
# Usage:
#   sbatch run_bagel_blink_multiview_2gpu_mix_balance_matterport_point_matching_no_think_lora.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/blink/training_data_mix_balance_matterport_point_matching_no_think_lora}"
