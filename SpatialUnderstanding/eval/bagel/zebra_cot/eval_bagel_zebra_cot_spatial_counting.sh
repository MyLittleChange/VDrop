#!/bin/bash
#SBATCH --job-name=bzc_spat_cnt
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_spat_cnt_%j.out
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/zebra_cot/slurm_logs/bzc_spat_cnt_%j.err
#SBATCH --ntasks=1
...
# Bagel-Zebra-CoT on COSMIC spatial: counting only
set -euo pipefail
