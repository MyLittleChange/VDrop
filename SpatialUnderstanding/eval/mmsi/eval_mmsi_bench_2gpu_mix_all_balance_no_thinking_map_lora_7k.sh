#!/bin/bash
#SBATCH --job-name=mmsi_all_nt_map_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_all_balance_no_thinking_map_lora_7k_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_all_balance_no_thinking_map_lora_7k_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_balance_no_thinking_map_lora_7k_mmsi_eval}"
...
echo "MMSI-Bench (no_thinking) — Model: $MODEL_PATH | Shards: $NUM_SHARDS | Batch: $SHARD_BATCH"
