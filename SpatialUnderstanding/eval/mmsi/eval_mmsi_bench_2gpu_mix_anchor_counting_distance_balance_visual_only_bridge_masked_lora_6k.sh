#!/bin/bash
#SBATCH --job-name=mmsi_all_bm_lora_6k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_bridge_masked_lora_6k_mmsi_eval}"
...
echo "MMSI-Bench (visual_only_thinking) — Model: $MODEL_PATH | Shards: $NUM_SHARDS | Batch: $SHARD_BATCH"
