#!/bin/bash
#SBATCH --job-name=bagel_vsibench_2gpu
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/vsibench/bagel_vsibench_2gpu_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/vsibench/bagel_vsibench_2gpu_error.txt
#SBATCH --ntasks=1
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL VSI-Bench Inference (2-GPU)"
echo "=============================================="
echo "Configuration:"
