#!/bin/bash
#SBATCH --job-name=bagel_mc_mat_pm_nt_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_balance_matterport_point_matching_no_think_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_balance_matterport_point_matching_no_think_lora_error.txt
#SBATCH --ntasks=1
...
# Usage:
#   sbatch run_bagel_mindcube_4gpu_mix_balance_matterport_point_matching_no_think_lora.sh
#   SHARD_BATCH=1 sbatch run_bagel_mindcube_4gpu_mix_balance_matterport_point_matching_no_think_lora.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/training_data_mix_balance_matterport_point_matching_no_think_lora}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL MindCube Inference (4-GPU short-unkillable, no_thinking)"
