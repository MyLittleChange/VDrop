#!/bin/bash
#SBATCH --job-name=blink_mv_vanilla
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_1gpu_vanilla_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_1gpu_vanilla_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL BLINK Multi-view_Reasoning Inference — 1 GPU on long
# Model: BAGEL-7B-MoT (vanilla, no fine-tuning)
# Think: false, Thinking mode: no_thinking
# Usage:
#   sbatch run_bagel_blink_multiview_1gpu_vanilla.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/blink/BAGEL_vanilla}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL BLINK Multi-view_Reasoning Inference (1-GPU long, no_thinking)"
echo "Model: BAGEL-7B-MoT (vanilla)"
echo "=============================================="
echo "Configuration:"
