#!/bin/bash
#SBATCH --job-name=rethink_und_direction
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/rethink_und_direction_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/rethink_und_direction_error.txt
#SBATCH --ntasks=1
...
#
# Usage:
#   sbatch run_bagel_rethink_direction_understanding.sh
#
set -euo pipefail
...
RESULTS_FILE="${RESULTS_FILE:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_rotation_balance_visual_only_mcqs_relative_direction_normalized/inference_results_bagel_merged.json}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_understanding_mcqs_relative_direction_normalized}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "Understanding Rethink Eval (1-GPU) — Direction"
echo "=============================================="
echo "Configuration:"
