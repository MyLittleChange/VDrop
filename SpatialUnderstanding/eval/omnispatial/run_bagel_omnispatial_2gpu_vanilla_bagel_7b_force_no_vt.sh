#!/bin/bash
#SBATCH --job-name=fnvt_omni_vanilla_bagel_7b
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_2gpu_vanilla_bagel_7b_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_2gpu_vanilla_bagel_7b_force_no_vt_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/omnispatial/BAGEL_7B_MoT_pretrained_complex_logic_perspective_taking_force_no_vt}"
