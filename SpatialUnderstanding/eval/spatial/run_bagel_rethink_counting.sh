#!/bin/bash
#SBATCH --job-name=bagel_rethink_counting
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_rethink_counting_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_rethink_counting_error.txt
#SBATCH --ntasks=1
...
#
# Usage:
#   sbatch run_bagel_rethink_counting.sh
#
set -euo pipefail
...
RESULTS_FILE="${RESULTS_FILE:-/path/to/scratch/VisualCoT/panorama_qa_visual_only_mcqs_counting_normalized/inference_results_bagel_merged.json}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_BAGEL_mcqs_counting_normalized}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL Rethink Inference (1-GPU) — Counting"
echo "=============================================="
echo "Configuration:"
