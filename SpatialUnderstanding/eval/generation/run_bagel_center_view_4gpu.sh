#!/bin/bash
#SBATCH --job-name=bagel_cv_4gpu
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_center_view_4gpu_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_center_view_4gpu_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL Center View Generation — 4 GPUs on short-unkillable
#
...
ANNOTATION_FILE="${ANNOTATION_FILE:-/path/to/scratch/VisualCoT/annotations/gemini_3_flash_preview_rendered_orbit_orbit_annotations_test.json}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/orbit_view_generation_test_set}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL Center View Generation (4-GPU)"
echo "=============================================="
echo "Configuration:"
