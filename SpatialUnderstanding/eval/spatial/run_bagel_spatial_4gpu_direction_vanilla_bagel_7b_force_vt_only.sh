#!/bin/bash
#SBATCH --job-name=fvt_direction_vanilla
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_force_vt_only_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_direction_vanilla_bagel_7b_force_vt_only_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_7B_MoT_pretrained_mcqs_relative_direction_normalized_force_vt_only}"
...
echo "=============================================="
echo "BAGEL Spatial — vanilla force_visual_thinking ONLY (direction)"
