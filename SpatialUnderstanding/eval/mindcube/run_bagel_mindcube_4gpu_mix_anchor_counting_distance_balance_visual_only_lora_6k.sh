#!/bin/bash
#SBATCH --job-name=bagel_mindcube_acd_vo_lora6k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_anchor_counting_distance_balance_visual_only_lora_6k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_4gpu_mix_anchor_counting_distance_balance_visual_only_lora_6k_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL MindCube Inference — 4 GPUs on short-unkillable
# Model: BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k
# Think: false, Thinking mode: visual_only_thinking
# Generates panorama images (720x1024)
#
set -euo pipefail
...
# ==================== Configuration ====================
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k}"

DATA_DIR="${DATA_DIR:-/path/to/scratch/datasets/MindCube/data}"
DATASET_FILES="${DATASET_FILES:-raw/MindCube_tinybench.jsonl}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL MindCube Inference (4-GPU, visual_only_thinking)"
echo "Model: BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k"
echo "=============================================="
echo "Configuration:"
