#!/bin/bash
#SBATCH --job-name=mmsi_acd_vo_lora6k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_anchor_counting_distance_balance_visual_only_lora_6k_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_mix_anchor_counting_distance_balance_visual_only_lora_6k_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k_mmsi_eval}"
...
echo "=============================================="
echo "MMSI-Bench Inference (visual_only_thinking)"
