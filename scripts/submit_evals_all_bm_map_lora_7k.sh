#!/bin/bash
# Submit benchmark eval jobs for the mix_all_balance_with_map bridge-masked LoRA 7k checkpoint:
#   BAGEL_format_mix_all_balance_with_map_visual_only_bridge_masked_lora_7k
#
# Subset chosen by user (other benchmarks evaluated on different clusters):
#   - all 5 spatial scripts -> main (2-GPU)
...
CKPT=mix_all_balance_with_map_visual_only_bridge_masked_lora_7k
