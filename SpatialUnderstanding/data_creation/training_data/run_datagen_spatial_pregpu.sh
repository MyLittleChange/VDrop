#!/bin/bash
#SBATCH --job-name=SpatialPreGPU
#SBATCH --partition=main
#SBATCH -c 4
#SBATCH --mem=32Gb
#SBATCH --time=24:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_pregpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/spatial_pregpu_error-%j.txt

# ==============================================================================
# Pre-GPU stages for NEW SPATIAL scenes in /network/scratch/.../infinigen/spatial/
# Stages: find_all_scenes, scene_filtering, scene_object_info,
#         scene_camera_info, scene_blender_color_info
# Requires: VisualCoT_GEMINI env var set before submitting.
# Run BEFORE run_datagen_spatial_gpu.sh.
# Usage: sbatch run_datagen_spatial_pregpu.sh
# ==============================================================================
...
log "Starting pre-GPU datagen stages (spatial scenes)..."
...
log "Next step: sbatch run_datagen_spatial_gpu.sh"
