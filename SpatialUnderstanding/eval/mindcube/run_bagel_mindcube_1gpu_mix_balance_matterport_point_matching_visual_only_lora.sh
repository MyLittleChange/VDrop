#!/bin/bash
#SBATCH --job-name=bagel_mc_mat_pm_vo_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_balance_matterport_point_matching_visual_only_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_1gpu_mix_balance_matterport_point_matching_visual_only_lora_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL MindCube Inference — 1 GPU on unkillable (finishes shard 3 of existing 4-shard split)
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_training_data_mix_balance_matterport_point_matching_visual_only_lora}"
...
echo "=============================================="
echo "BAGEL MindCube Inference (1-GPU unkillable, visual_only_thinking, shard 3 cleanup)"
