#!/bin/bash
#SBATCH --job-name=tm_spat_dst
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/thinkmorph/slurm_logs/tm_spat_dst_%j.out
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/thinkmorph/slurm_logs/tm_spat_dst_%j.err
#SBATCH --ntasks=1
...
# ThinkMorph-7B on COSMIC spatial: distance only
set -euo pipefail
