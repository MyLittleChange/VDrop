#!/bin/bash
#SBATCH --job-name=bagel_stare_all_tt_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_all_balance_text_thinking_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_all_balance_text_thinking_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_format_training_data_mix_all_balance_text_thinking_lora_7k}"
...
echo "BAGEL STARE Perspective (text_thinking) — Model: $MODEL_PATH | Shard: $SHARD_IDX/$NUM_SHARDS"
