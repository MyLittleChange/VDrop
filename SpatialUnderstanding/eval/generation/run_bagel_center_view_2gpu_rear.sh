...
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_3}"

ANNOTATION_FILE="${ANNOTATION_FILE:-/path/to/scratch/VisualCoT/annotations/spatial_dataset_V_Final_2000_parsed_qa.json}"

OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/parsed_qa_anchor_cenetr_spatial_rear_visual_only_spatial_test_set}"
