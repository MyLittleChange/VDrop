#!/bin/bash
#SBATCH --job-name=bagel_stare_all_td_vo_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_training_data_mix_all_balance_topdown_visual_only_topdown_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_training_data_mix_all_balance_topdown_visual_only_topdown_lora_7k_error.txt
#SBATCH --ntasks=1
...
# Model: BAGEL_format_training_data_mix_all_balance_topdown_visual_only_topdown_lora_7k
...
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_training_data_mix_all_balance_topdown_visual_only_topdown_lora_7k}"
DATA_FILE="${DATA_FILE:-/path/to/scratch/datasets/STARE/perspective/test-00000-of-00001.parquet}"
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_format_training_data_mix_all_balance_topdown_visual_only_topdown_lora_7k}"
