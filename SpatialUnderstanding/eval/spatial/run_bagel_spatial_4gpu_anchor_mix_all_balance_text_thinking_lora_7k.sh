#!/bin/bash
#SBATCH --job-name=bagel_spat_anc_all_tt_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_mix_all_balance_text_thinking_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_mix_all_balance_text_thinking_lora_7k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_balance_text_thinking_lora_7k_mcqs_anchor_normalized}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL Spatial Collaboration Inference (text_thinking, anchor)"
echo "Model: BAGEL_format_training_data_mix_all_balance_text_thinking_lora_7k"
echo "=============================================="
echo "Configuration:"
