#!/bin/bash
#SBATCH --job-name=mmsi_mat_nt_lora9k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_mix_balance_matterport_no_think_lora_9k_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_mix_balance_matterport_no_think_lora_9k_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_balance_matterport_no_think_lora_9k_mmsi_eval}"
