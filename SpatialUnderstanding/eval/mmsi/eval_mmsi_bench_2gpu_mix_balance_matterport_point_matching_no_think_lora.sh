#!/bin/bash
#SBATCH --job-name=mmsi_mat_pm_nt_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_mix_balance_matterport_point_matching_no_think_lora_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_inference_mix_balance_matterport_point_matching_no_think_lora_error_%a.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/training_data_mix_balance_matterport_point_matching_no_think_lora_mmsi_eval}"
...
echo "=============================================="
echo "MMSI-Bench Inference (2-GPU main, no_thinking)"
