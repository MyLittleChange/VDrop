...
def main():
    ...
    parser.add_argument("--source_file", help="Source safetensors file (with more keys)",default='/path/to/scratch/models/BAGEL-7B-MoT/ema.safetensors')
    parser.add_argument("--target_file", help="Target safetensors file (with fewer keys)",default='/path/to/scratch/VisualCoT/BAGEL_checkpoints/text_only_no_thinking_understanding/0005000/model.safetensors')
    parser.add_argument("--output_file", help="Output merged safetensors file",default='/path/to/scratch/VisualCoT/BAGEL_checkpoints/text_only_no_thinking_understanding/0005000/model_full.safetensors')
    parser.add_argument(
        "--force",
        action="store_true",
