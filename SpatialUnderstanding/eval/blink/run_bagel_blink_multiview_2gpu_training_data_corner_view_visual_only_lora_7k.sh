#!/bin/bash
#SBATCH --job-name=blink_mv_cv_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_training_data_corner_view_visual_only_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_training_data_corner_view_visual_only_lora_7k_error.txt
#SBATCH --ntasks=1
...
SPLIT="${SPLIT:-val}"
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/blink/BAGEL_format_training_data_corner_view_visual_only_lora_7k}"
