#!/bin/bash
#SBATCH --job-name=fnvt_stare_vanilla_bagel_7b
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_1gpu_vanilla_bagel_7b_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_1gpu_vanilla_bagel_7b_force_no_vt_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_7B_MoT_pretrained_force_no_vt}"
