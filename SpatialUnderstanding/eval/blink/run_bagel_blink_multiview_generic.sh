#!/bin/bash
#SBATCH --job-name=bagel_blink_generic
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/slurm_logs/blink/%x_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/slurm_logs/blink/%x_error.txt
#SBATCH --ntasks=1
...
# Generic BAGEL BLINK Multi-view_Reasoning Inference — 2 GPUs
...
echo "BLINK | Model: ${MODEL_PATH##*/} | Thinking: ${THINKING_MODE} | Shards: ${SHARD_INDICES[*]}/${NUM_SHARDS}"
