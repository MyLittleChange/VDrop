#!/bin/bash
#SBATCH --job-name=bagel_omni_acd_vo_lora6k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_mix_anchor_counting_distance_balance_visual_only_lora_6k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/omnispatial/slurm_logs/bagel_omnispatial_mix_anchor_counting_distance_balance_visual_only_lora_6k_error.txt
#SBATCH --ntasks=1
...
# Think: true, Thinking mode: visual_only_thinking
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/omnispatial/BAGEL_format_mix_anchor_counting_distance_balance_visual_only_lora_6k_complex_logic_perspective_taking}"
