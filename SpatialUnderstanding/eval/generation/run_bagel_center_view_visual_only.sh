...
# ==================== Configuration ====================
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_orbit_orbit_annotations_parsed_qa_train_visual_only_thinking}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/orbit_orbit_annotations_parsed_qa_train_visual_only_thinking_parsed_qa_test}"
