#!/bin/bash
#SBATCH --job-name=bagel_map_mat_pm_nt_lora
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_mix_balance_matterport_point_matching_no_think_lora_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_mix_balance_matterport_point_matching_no_think_lora_error.txt
#SBATCH --ntasks=1
...
# Usage:
#   sbatch run_bagel_spatial_map_1gpu_mix_balance_matterport_point_matching_no_think_lora.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/training_data_mix_balance_matterport_point_matching_no_think_lora_map_questions_normalized}"
