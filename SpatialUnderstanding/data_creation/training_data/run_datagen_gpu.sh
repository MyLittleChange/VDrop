#!/bin/bash
#SBATCH --job-name=DatagenGPU
#SBATCH --gres=gpu:a100l:4
#SBATCH -c 8
#SBATCH --mem=120Gb
#SBATCH --time=2:00:00
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/gpu_output-%j.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/data_creation/training_data/slurm_logs/gpu_error-%j.txt

#SBATCH --partition=short-unkillable
# ==============================================================================
# GPU stage: scene_llm_visible_objects (Qwen3-VL-235B via vLLM)
# Run AFTER run_datagen_pregpu.sh and BEFORE run_datagen_postgpu.sh.
# Usage: sbatch run_datagen_gpu.sh
# ==============================================================================
...
log "Next step: sbatch run_datagen_postgpu.sh"
