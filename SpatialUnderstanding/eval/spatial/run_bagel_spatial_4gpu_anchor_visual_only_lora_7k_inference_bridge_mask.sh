#!/bin/bash
#SBATCH --job-name=ibm_anchor_visual_only_lor
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_visual_only_lora_7k_inference_bridge_mask_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_anchor_visual_only_lora_7k_inference_bridge_mask_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_balance_visual_only_lora_7k_mcqs_anchor_normalized_inference_bridge_mask}"
