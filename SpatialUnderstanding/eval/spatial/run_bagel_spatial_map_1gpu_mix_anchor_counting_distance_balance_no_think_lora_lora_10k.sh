#!/bin/bash
#SBATCH --job-name=bagel_map_acd_nt_lora10k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_mix_anchor_counting_distance_balance_no_think_lora_lora_10k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_map_mix_anchor_counting_distance_balance_no_think_lora_lora_10k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_mix_anchor_counting_distance_balance_no_think_lora_lora_10k_map_questions_normalized}"
