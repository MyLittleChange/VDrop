#!/bin/bash
#SBATCH --job-name=fnvt_distance_visual_only_l
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_distance_visual_only_lora_7k_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_distance_visual_only_lora_7k_force_no_vt_error.txt
#SBATCH --ntasks=1
...
# Task: distance | Model: visual_only_lora_7k
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_mix_all_balance_visual_only_lora_7k_mcqs_relative_distance_normalized_force_no_vt}"
