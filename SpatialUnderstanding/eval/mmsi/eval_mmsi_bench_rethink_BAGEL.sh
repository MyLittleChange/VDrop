#!/bin/bash
#SBATCH --job-name=mmsi_rethink_BAGEL
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_rethink_BAGEL_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_rethink_BAGEL_error.txt
#SBATCH --ntasks=1
...
#
# Usage:
#   sbatch eval_mmsi_bench_rethink_BAGEL.sh
#
set -euo pipefail
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/rethink_BAGEL_mmsi}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "MMSI-Bench Rethink Inference (1-GPU) — BAGEL-7B-MoT"
echo "=============================================="
echo "Configuration:"
