...
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_vanilla_interleaved_output_%a.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/mmsi_log/mmsi_vanilla_interleaved_error_%a.txt
#SBATCH --ntasks=1
...
# (Model decides text vs visual thinking; no system-prompt-forced bridge generation.)
#
