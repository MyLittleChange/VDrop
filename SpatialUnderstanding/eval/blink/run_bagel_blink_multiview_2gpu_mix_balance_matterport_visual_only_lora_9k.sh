#!/bin/bash
#SBATCH --job-name=blink_mv_mat_vo9k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_mix_balance_matterport_visual_only_lora_9k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/blink/bagel_blink_multiview_2gpu_mix_balance_matterport_visual_only_lora_9k_error.txt
#SBATCH --ntasks=1
...
SPLIT="${SPLIT:-val}"
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/blink/BAGEL_format_training_data_mix_balance_matterport_visual_only_lora}"
