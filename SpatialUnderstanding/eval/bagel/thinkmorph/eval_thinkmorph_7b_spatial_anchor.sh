#!/bin/bash
#SBATCH --job-name=tm_spat_anc
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/thinkmorph/slurm_logs/tm_spat_anc_%j.out
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/bagel/thinkmorph/slurm_logs/tm_spat_anc_%j.err
#SBATCH --ntasks=1
...
# ThinkMorph-7B on COSMIC spatial: anchor only
set -euo pipefail
