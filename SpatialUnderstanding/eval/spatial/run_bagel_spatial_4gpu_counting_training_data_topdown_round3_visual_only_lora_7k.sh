#!/bin/bash
#SBATCH --job-name=bagel_spat_cnt_all_tdr3_lora_7k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_training_data_topdown_round3_visual_only_lora_7k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/bagel/bagel_spatial_4gpu_counting_training_data_topdown_round3_visual_only_lora_7k_error.txt
#SBATCH --ntasks=1
...
#
# BAGEL Spatial Collaboration Inference (counting) — 4 GPUs on short-unkillable
# Model: BAGEL_format_training_data_topdown_round3_visual_only_lora_7k
...
# ==================== Configuration ====================
MODEL_PATH="${MODEL_PATH:-/path/to/scratch/VisualCoT/BAGEL_checkpoints/BAGEL_format_training_data_topdown_round3_visual_only_lora_7k}"
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/BAGEL_format_training_data_topdown_round3_visual_only_lora_7k_mcqs_counting_normalized}"
...
echo "=============================================="
echo "BAGEL Spatial Collaboration Inference (visual_only_thinking, counting)"
echo "Model: BAGEL_format_training_data_topdown_round3_visual_only_lora_7k"
echo "=============================================="
