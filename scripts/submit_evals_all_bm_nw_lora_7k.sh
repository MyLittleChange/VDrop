#!/bin/bash
# Submit benchmark eval jobs for the mix_all_balance bridge-masked no-warmup LoRA 7k checkpoint:
#   BAGEL_format_mix_all_balance_visual_only_bridge_masked_no_warmup_lora_7k
#
...
CKPT=mix_all_balance_visual_only_bridge_masked_no_warmup_lora_7k
