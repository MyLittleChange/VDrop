#!/bin/bash
#SBATCH --job-name=fnvt_mc_visual_only_bridge_
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_2gpu_visual_only_bridge_masked_lora_7k_force_no_vt_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/mindcube/bagel_mindcube_2gpu_visual_only_bridge_masked_lora_7k_force_no_vt_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/mindcube/BAGEL_format_mix_all_balance_visual_only_bridge_masked_lora_7k_force_no_vt}"
