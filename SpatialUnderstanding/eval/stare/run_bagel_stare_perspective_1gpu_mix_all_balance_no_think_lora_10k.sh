#!/bin/bash
#SBATCH --job-name=bagel_stare_balance_nt_lora10k
#SBATCH --output=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_all_balance_no_think_lora_10k_output.txt
#SBATCH --error=/path/to/ThinkMorph-BAGEL-release/SpatialUnderstanding/eval/stare/slurm_logs/bagel_stare_perspective_mix_all_balance_no_think_lora_10k_error.txt
#SBATCH --ntasks=1
...
OUTPUT_DIR="${OUTPUT_DIR:-/path/to/scratch/VisualCoT/stare_perspective/BAGEL_format_mix_all_balance_no_think_lora_10k}"
...
# ==================== Print Configuration ====================
echo "=============================================="
echo "BAGEL STARE Perspective Inference (1-GPU, no_thinking)"
echo "=============================================="
echo "Configuration:"
